...
How to add or edit a skill in this runtime so it stays consistent and lean. Use this when creating/changing anything in `../skills/`.
...
## Rules
- Name `unity-<verb>`. Keep the skill lean (~20–35 lines).
- Push deep reference into `../knowledge/`, not the skill body.
...
1. Add a route row in `../context/Workflows.md` (command + trigger phrases + skill + output).
